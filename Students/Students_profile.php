...
if(isset($_POST['new_update']))
{
    ...
    $result = mysqli_query($conn,"update tblstudents set FirstName='$fname', LastName='$lname', EmailId='$email', Gender='$gender', Dob='$dob', Department='$department', Address='$address', Phonenumber='$phonenumber' where std_id='$session_id'         
		")or die(mysqli_error());
    if ($result) {
     	echo "<script>alert('Your records Successfully Updated');</script>";
     	echo "<script type='text/javascript'> document.location = 'Students_profile.php'; </script>";
	} else{
	  die(mysqli_error());
   }
...
if (isset($_POST["update_image"])) {
    ...
    $result = mysqli_query($conn,"update tblstudents set location='$location' where std_id='$session_id'         
		")or die(mysqli_error());
    if ($result) {
					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="HOD_dashboard">Dashboard</a></li>
														...
														<div class="weight-500 col-md-6">
															<div class="form-group">
																...
																<select name="department" class="custom-select form-control" required="true" autocomplete="off">
																	<?php
																		$query_Students = mysqli_query($conn,"select * from tblstudents join  tbldepartments where std_id = '$session_id'")or die(mysqli_error());
