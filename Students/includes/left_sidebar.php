<div class="left-side-bar">
		<div class="brand-logo">
			<a href="HOD_dashboard.php">
				<img src="../vendors/images/ksrct-blue.png" alt="" class="dark-logo">
				<img src="../vendors/images/ksrct-white.png" alt="" class="light-logo">
			</a>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li>
						<a href="https://ksrct.ac.in/" class="dropdown-toggle no-arrow">
