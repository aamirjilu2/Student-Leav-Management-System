...
<?php
	...
	{ 
		...
		elseif ($status === '1') {
				$result = mysqli_query($conn,"update tblleaves, tblstudents set tblleaves.registra_remarks='$description',tblleaves.admin_status='$status',tblleaves.AdminRemarkDate='$admremarkdate', tblstudents.Av_leave='$REMLEAVE' where tblleaves.empid = tblstudents.std_id AND tblleaves.id='$did'");
