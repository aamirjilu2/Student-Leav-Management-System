...
<?php
	...
	{ 
		...
		if ($status === '2') {
			$sql="update tblleaves set registra_remarks=:description,HOD_status=:status,HODRemarkDate=:admremarkdate where id=:did";
		...
		elseif ($status === '1') {
				$result = mysqli_query($conn,"update tblleaves, tblstudents set tblleaves.registra_remarks='$description',tblleaves.HOD_status='$status',tblleaves.HODRemarkDate='$admremarkdate', tblstudents.Av_leave='$REMLEAVE' where tblleaves.empid = tblstudents.std_id AND tblleaves.id='$did'");
			...
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					...
					<form metHOD="post" action="">
						...
						<div class="form-group row">
								<label style="font-size:16px;" class="col-sm-12 col-md-2 col-form-label"><b>Hear Faculty Remarks</b></label>
								<div class="col-sm-12 col-md-10">
									<?php
									if ($result->HODRemark==""): ?>
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group">
									<label style="font-size:16px;"><b>Head Faculty Status</b></label>
