				...
				<div class="col-lg-4 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px">
						<div class="d-flex justify-content-between pb-10">
							<div class="h5 mb-0">Department HOD</div>
						...
						<div class="user-list">
							<ul>
								<?php
		                         $query = mysqli_query($conn,"select * from tblstudents where role='HOD' ORDER BY tblstudents.std_id desc limit 4") or die(mysqli_error());
					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								...
								<?php 
								$status=1;
								$sql = "SELECT tblleaves.id as lid,tblstudents.FirstName,tblstudents.LastName,tblstudents.location,tblstudents.std_id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Status, tblleaves.HOD_status from tblleaves join tblstudents on tblleaves.empid=tblstudents.std_id where tblleaves.Status= '$status' order by lid desc limit 5";
								...
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
											...
											<a class="dropdown-item" href="HOD_dashboard.php?leaveid=<?php echo $row['lid']; ?>"><i class="dw dw-delete-3"></i> Delete</a>
										</div>
									</div>
								</td>
							</tr>
