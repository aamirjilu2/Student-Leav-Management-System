...
if (isset($_POST['signin'])) {
    ...
    // Check the HOD table
    $sql = "SELECT * FROM tblHOD WHERE EmailId ='$username' AND Password ='$password'";
    ...
    if ($count > 0) {
        ...
        $sql = "SELECT * FROM tblFaculty WHERE EmailId ='$username' AND Password ='$password'";
        $query = mysqli_query($conn, $sql);
        $count = mysqli_num_rows($query);
        ...
        if ($count > 0) {
            $row = mysqli_fetch_assoc($query);
            $_SESSION['alogin'] = $row['std_id'];
            $_SESSION['arole'] = 'Faculty';
            echo "<script type='text/javascript'> document.location = 'faculty/index.php'; </script>";
        } else {
            ...
            if ($count > 0) {
                $row = mysqli_fetch_assoc($query);
                $_SESSION['alogin'] = $row['std_id'];
                $_SESSION['arole'] = 'Students';
                echo "<script type='text/javascript'> document.location = 'Students/index.php'; </script>";
            } else {
...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>KSRCT Leave System</title>

	<!-- Site favicon -->
	<link rel="ksrct1" sizes="180x180" href="vendors/images/ksrct1.png">
	<link rel="icon" type="image/png" sizes="32x32" href="vendors/images/ksrct2.png">
	<link rel="icon" type="image/png" sizes="16x16" href="vendors/images/ksrct3.png">
	...
	<div class="login-header box-shadow">
		<div class="container-fluid d-flex justify-content-between align-items-center">
			<div class="brand-logo">
				<a href="login.html">
					<img src="vendors/images/ksrct-blue.png" alt="">
				</a>
			</div>
		</div>
	</div>
