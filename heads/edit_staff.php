...
<?php
	...
	$result = mysqli_query($conn,"update tblstudents set FirstName='$fname', LastName='$lname', EmailId='$email', Gender='$gender', Dob='$dob', Department='$department', Address='$address', Av_leave='$leave_days', role='$user_role', Phonenumber='$phonenumber' where std_id='$get_id'         
		"); 		
	if ($result) {
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Students Edit</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Edit Students</h4>
							<p class="mb-20"></p>
						</div>
					</div>
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<select name="department" class="custom-select form-control" required="true" autocomplete="off">
												<?php
													$query_Students = mysqli_query($conn,"select * from tblstudents join  tbldepartments where std_id = '$get_id'")or die(mysqli_error());
													$row_Students = mysqli_fetch_array($query_Students);
													
												 ?>
												<option value="<?php echo $row_Students['DepartmentShortName']; ?>"><?php echo $row_Students['DepartmentName']; ?></option>
													<?php
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<div class="modal-footer justify-content-center">
												<button class="btn btn-primary" name="add_Students" id="add_Students" data-toggle="modal">Update&nbsp;Students</button>
											</div>
										</div>
									</div>
								</div>
