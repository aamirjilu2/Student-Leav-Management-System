...
<?php
	...
	{ 
		...
		if ($status === '2') {
			$result = mysqli_query($conn,"update tblleaves, tblstudents set tblleaves.HODRemark='$description',tblleaves.Status='$status',tblleaves.HODRemarkDate='$admremarkdate', tblleaves.registra_remarks = '$reg_remarks', tblleaves.HOD_status = '$reg_status' where tblleaves.empid = tblstudents.std_id AND tblleaves.id='$did'");
		...
		elseif ($status === '1') {
				$result = mysqli_query($conn,"update tblleaves, tblstudents set tblleaves.HODRemark='$description',tblleaves.Status='$status',tblleaves.HODRemarkDate='$admremarkdate' where tblleaves.empid = tblstudents.std_id AND tblleaves.id='$did'");
		...
		// $sql="update tblleaves set HODRemark=:description,Status=:status,HODRemarkDate=:admremarkdate where id=:did";
			...
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					...
					<form metHOD="post" action="">
						...
						$sql = "SELECT tblleaves.id as lid,tblstudents.FirstName,tblstudents.LastName,tblstudents.std_id,tblstudents.Gender,tblstudents.Phonenumber,tblstudents.EmailId,tblstudents.Av_leave,tblleaves.LeaveType,tblleaves.ToDate,tblleaves.FromDate,tblleaves.Description,tblleaves.PostingDate,tblleaves.Status,tblleaves.HODRemark,tblleaves.HOD_status,tblleaves.registra_remarks,tblleaves.HODRemarkDate,tblleaves.num_days from tblleaves join tblstudents on tblleaves.empid=tblstudents.std_id where tblleaves.id=:lid";
						$query = $dbh -> prepare($sql);
						...
						<div class="form-group row">
								<label style="font-size:16px;" class="col-sm-12 col-md-2 col-form-label"><b>Head Faculty Remarks</b></label>
								<div class="col-sm-12 col-md-10">
									<?php
									if ($result->HODRemark==""): ?>
									...
									<?php else: ?>
									  <input type="text" class="selectpicker form-control" data-style="btn-outline-primary" readonly value="<?php echo htmlentities($result->HODRemark); ?>">
									<?php endif ?>
								</div>
						</div>
						<div class="form-group row">
								<label style="font-size:16px;" class="col-sm-12 col-md-2 col-form-label"><b>Faculty Remarks</b></label>
								<div class="col-sm-12 col-md-10">
									<?php
						...
						<div class="row">
							<div class="col-md-3">
								<div class="form-group">
								   ...
								   <?php
									if ($result->HODRemarkDate==""): ?>
									  <input type="text" class="selectpicker form-control" data-style="btn-outline-primary" readonly value="<?php echo "NA"; ?>">
									<?php else: ?>
									  <input type="text" class="selectpicker form-control" data-style="btn-outline-primary" readonly value="<?php echo htmlentities($result->HODRemarkDate); ?>">
									<?php endif ?>
							...
							<form name="HODaction" metHOD="post">
